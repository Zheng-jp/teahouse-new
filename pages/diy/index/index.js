...
BackgroundAudioManager.title = "", Page((_defineProperty(_Page = {
  ...
  getUncacid: function(params, callback) {
    wx.request({
...
// console.log(app.globalData.isRefresh)
    ...
    wx.request({
      ...
      success: function(t) {
        var a = t.data.data,
          ...
          n = t.data.data.s2.s2v,
          i = t.data.data.c2.c2v,
          s = new Array(),
          d = new Array(),
          r = new Array(),
          c = new Array();
  ...
  formSubmit: function(t) {
    ...
    var n = new Date(),
      i = n.getMonth() + 1 + "" + n.getDate() + (3600 * n.getHours() + 60 * n.getMinutes() + n.getSeconds()),
      s = wx.getStorageSync("mypretime");
  ...
  riqi: function() {
    ...
    var i = [],
      ...
      d = new Date();
    for (n = 0; n < 5; n++) {
      var r = new Date(d.getTime() + 24 * n * 3600 * 1e3),
        c = r.getFullYear(),
        l = r.getMonth() + 1,
        u = r.getDate(),
        f = l + "月" + u + "日",
  ...
  formSubmit1: function(t) {
    ...
    for (var e = 0; e < a.length; e++) {
      ...
      if (5 == a[e].type && 0 < a[e].z_val.length)
        for (var o = 0; o < a[e].z_val.length; o++) {
